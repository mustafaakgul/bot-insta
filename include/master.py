...
class InstaBot:
    ...
    def __init__(self, username, psw):
        self.driver = webdriver.Chrome(executable_path="/Users/mustafaakgul/Documents/Apps/BotInstaScripts/include/chromedriver")
...
my_bot = InstaBot("Ahmt55ylmz","147369ay")
