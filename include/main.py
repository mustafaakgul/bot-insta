...
if __name__ == '__main__':
    try:
        ...
        browser.find_element_by_xpath(
            "/html/body/div[1]/section/main/div/article/div/div[1]/div/form/div[6]/div/label/input").send_keys(password)
        print("password")
        ...
        browser.find_element_by_xpath(
            "/html/body/div[1]/section/main/div/article/div/div[1]/div/div[4]/div/div/span/span[3]/select").send_keys(
            "2001")
        print("date")
        ...
        autenthication_code = WebDriverWait(browser, 20).until(EC.presence_of_element_located((By.XPATH,
                                                                                               "/html/body/div[4]/div/div/div/div[2]/div[2]/div[4]/div[3]/table/tbody/tr/td/table/tbody/tr[4]/td/table/tbody/tr/td/table/tbody/tr[2]/td[2]/table/tbody/tr[2]/td[2]"))).text
        ...
        response = browser.find_element_by_xpath(
            "/html/body/div[1]/section/main/div/article/div/div[1]/div[2]/form/div/div[4]/div").text
        print(response)
        ...
        for times in range(10):
            # like pic
            browser.find_element_by_xpath(
                "/html/body/div[5]/div[2]/div/article/div[3]/section[1]/span[1]/button/div/span/svg").click()
            # get description
            description = browser.find_element_by_xpath(
                "/html/body/div[5]/div[2]/div/article/div[3]/div[1]/ul/div/li/div/div/div[2]/span").text
        ...
        # exit account
        browser.find_element_by_xpath(
            "/html/body/div[1]/section/nav/div[2]/div/div/div[3]/div/div[5]/div[2]/div/div[2]/div[2]/div[2]/div/div/div/div/div/div").click()
